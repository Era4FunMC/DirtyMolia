...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("me.earthme.molia:molia-api")
...
paperweight {
    serverProject.set(project(":molia-server"))
    ...
    useStandardUpstream("molia") {
        ...
        withStandardPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("Molia-API"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("Molia-Server"))
        }
    }
}
